...
public class Level3f extends Level {
    ...
    public static File redFile = new File("Levels/Level3/red.ser");
    public static File boomFile = new File("Levels/Level3/boom.ser");
    public static File chuckFile = new File("Levels/Level3/chuck.ser");
    public static File kingFile = new File("Levels/Level3/king.ser");
    public static File normalFile = new File("Levels/Level3/normal.ser");
    public static File muchFile = new File("Levels/Level3/much.ser");
    public static File iceBlockFile = new File("Levels/Level3/iceBlock.ser");
    public static File iceBlock2File = new File("Levels/Level3/iceBlock2.ser");
    public static File iceBlock3File = new File("Levels/Level3/iceBlock3.ser");
    public static File iceBlock4File = new File("Levels/Level3/iceBlock4.ser");
    public static File iceBlock5File = new File("Levels/Level3/iceBlock5.ser");
    public static File iceBlock6File = new File("Levels/Level3/iceBlock6.ser");
    public static File iceBlock7File = new File("Levels/Level3/iceBlock7.ser");
    public Level3f(Main M) {
    ...
    public static ArrayList<Piggies> getBlocksofLevel() {
        return piggies;
    }
...
//                 Add logic for Much pig taking damage
    ...
    private void loadAndPrepareStage() throws IOException, ClassNotFoundException, InterruptedException {
        bgTP = "background.png";
        KingTP = "King.png";
        ...
        red = new Red(world, 200, 240,100,100);
        bomb = new Bomb(world, 100, 240,100,100);
        chuck = new Chuck(world, 300, 240,100,100);
        king = new King(world,new Sprite(new Texture(KingTP)), 600, 240);
        float IceBlocksHeight = king.getHeight()+30f;
        iceBlock4 = new DynamicBodies(world, new Sprite(new Texture(StoneBlockTP)), 530, 240,20,IceBlocksHeight);
        iceBlock = new DynamicBodies(world, new Sprite(new Texture(WoodBlockTP)), 680, 240,20,IceBlocksHeight);
        normal = new Normal(world,new Sprite(new Texture(NormalTP)), 750, 240);
        iceBlock2 = new DynamicBodies(world, new Sprite(new Texture(StoneBlockTP)), 880, 240,20,IceBlocksHeight);
        much = new Much(world,new Sprite(new Texture(MuchTP)), 950, 240);
        iceBlock3 = new DynamicBodies(world, new Sprite(new Texture(WoodBlockTP)),1130, 240,20,IceBlocksHeight);

        tempSprite = new Sprite(new Texture(StoneBlockTP));
        tempSprite.rotate90(true);
        if(tempSprite == null){
            System.out.println("Temp Sprite is Null");
        }
        iceBlock5 = new DynamicBodies(world, tempSprite,0, 0,352,20);
        iceBlock6 = new DynamicBodies(world, tempSprite, 0, 0,300,20);
        iceBlock7 = new DynamicBodies(world, tempSprite, 0, 0,250,20);
        ...
        king.getBody().setTransform(1050,300,0);
        iceBlock2.getBody().setTransform(1250,300,0);
        normal.getBody().setTransform(1400,250,0);
        iceBlock3.getBody().setTransform(1550,300,0);
        much.getBody().setTransform(1650,250,0);
        iceBlock4.getBody().setTransform(1800,300,0);
        iceBlock5.getBody().setTransform(iceBlock.getBody().getPosition().x+(iceBlock5.getWidth()/2), iceBlock.getBody().getPosition().y+iceBlock.getHeight()-20,0);
