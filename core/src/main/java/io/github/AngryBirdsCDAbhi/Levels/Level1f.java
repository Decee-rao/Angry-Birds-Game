...
public class Level1f extends Level {
    ...
    public static File redFile = new File("Levels/Level1/red.ser");
    public static File boomFile = new File("Levels/Level1/boom.ser");
    public static File chuckFile = new File("Levels/Level1/chuck.ser");
    public static File kingFile = new File("Levels/Level1/king.ser");
    public static File normalFile = new File("Levels/Level1/normal.ser");
    public static File muchFile = new File("Levels/Level1/much.ser");
    public static File iceBlockFile = new File("Levels/Level1/iceBlock.ser");
    public static File iceBlock2File = new File("Levels/Level1/iceBlock2.ser");
    public static File iceBlock3File = new File("Levels/Level1/iceBlock3.ser");
    public static File iceBlock4File = new File("Levels/Level1/iceBlock4.ser");
    public static File iceBlock5File = new File("Levels/Level1/iceBlock5.ser");
    public static File iceBlock6File = new File("Levels/Level1/iceBlock6.ser");
    public static File iceBlock7File = new File("Levels/Level1/iceBlock7.ser");
    //Constructor to set the texture paths
    public Level1f(Main M) {
...
//        king.deactivate();
    ...
    public void loadAndPrepareStage() throws IOException, ClassNotFoundException, InterruptedException {
        ...
        iceBlock3 = new DynamicBodies(world, new Sprite(new Texture(IceBlockTP)),1130, 240,20,IceBlocksHeight);
        ...
        normal.getBody().setTransform(1400,300,0);
        iceBlock3.getBody().setTransform(1550,300,0);
        much.getBody().setTransform(1650,300,0);
        ...
        chuck = new Chuck(world, 200, 240,100,150);
        ...
        birds.add(bomb);
        birds.add(chuck);
        inGameMenu = new InGameMenu(viewport,camera,1,main);
